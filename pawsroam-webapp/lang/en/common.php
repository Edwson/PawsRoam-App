...
return [
    ...
    // Coupon Management (Business Admin & Super Admin)
    'page_title_manage_coupons' => 'Manage Your Coupons',
    'button_add_new_coupon' => 'Add New Coupon',
    'manage_coupons_description_stub' => 'Here you can view, create, edit, and manage discount coupons for your business(es). Full functionality for listing and actions will be implemented soon.',
    'filter_coupons_title_stub' => 'Filter Coupons',
    'filter_by_business_stub' => 'Filter by Business',
    'all_businesses_stub' => 'All Businesses',
    'filter_by_status_stub' => 'Filter by Status',
    'all_statuses_stub' => 'All Statuses',
    'coupon_status_active' => 'Active',
    'coupon_status_inactive' => 'Inactive',
    'coupon_status_expired' => 'Expired',
    'coupon_status_fully_redeemed' => 'Fully Redeemed',
    'button_filter_stub' => 'Filter',
    'loading_coupons_stub' => 'Loading your coupons...',
    'coupon_th_title' => 'Title',
    'coupon_th_business' => 'Business',
    'coupon_th_code' => 'Code',
    'coupon_th_status' => 'Status',
    'coupon_th_dates' => 'Active Dates',
    'coupon_th_usage' => 'Usage (Redeemed/Total)',
    'coupon_th_actions' => 'Actions',
    'tooltip_edit_coupon_stub' => 'Edit this coupon',
    'no_coupons_found_for_business_stub' => 'You have not created any coupons yet. Click "Add New Coupon" to get started!',
    'page_title_create_coupon' => 'Create New Coupon',
    'button_back_to_manage_coupons' => 'Back to Manage Coupons',
    'coupon_form_business_label' => 'For Business',
    'select_placeholder_business' => '-- Select Business --',
    'coupon_creating_for_business_stub %s' => 'Creating coupon for: <strong>%s</strong>. (Stub message)',
    'coupon_form_no_business_warning_stub' => 'You must have an active, approved business profile to create coupons. Please set up your business first. (Stub)',
    'coupon_form_title_label' => 'Coupon Title / Offer Name',
    'coupon_form_title_placeholder_stub' => 'e.g., 10% Off All Dog Treats',
    'coupon_form_description_label' => 'Description (Optional)',
    'coupon_form_description_placeholder_stub' => 'e.g., Limited time offer for our furry friends!',
    'coupon_form_code_label' => 'Coupon Code (Optional)',
    'coupon_form_code_placeholder_stub' => 'e.g., SAVE10, PAWSOMEDEAL',
    'coupon_form_code_help_stub' => 'Leave blank for automatic code or if not applicable. Must be unique if provided.',
    'coupon_form_discount_type_label' => 'Discount Type',
    'select_placeholder_discount_type' => '-- Select Discount Type --',
    'coupon_type_percentage' => 'Percentage Off',
    'coupon_type_fixed_amount' => 'Fixed Amount Off',
    'coupon_type_free_item' => 'Free Item',
    'coupon_type_service_upgrade' => 'Service Upgrade',
    'coupon_form_discount_value_label' => 'Discount Value',
    'coupon_form_discount_value_placeholder_stub' => 'e.g., 10 (for 10%), 5.00 (for $5 off)',
    'coupon_form_discount_value_help_stub' => 'Enter numeric value for percentage/fixed. For free item/upgrade, describe it (e.g., "Small Plush Toy", "Deluxe Spa Treatment").',
    'coupon_form_item_name_label_stub' => 'Free Item Name',
    'coupon_form_item_name_placeholder_stub' => 'e.g., Premium Dog Chew Toy',
    'coupon_form_service_upgrade_label_stub' => 'Service Upgrade Details',
    'coupon_form_service_upgrade_placeholder_stub' => 'e.g., Upgrade from Standard to Deluxe Grooming Package',
    'coupon_form_start_date_label' => 'Start Date & Time',
    'coupon_form_end_date_label' => 'End Date & Time',
    'coupon_form_usage_limit_total_label' => 'Total Usage Limit (Optional)',
    'coupon_form_usage_limit_placeholder_stub' => 'e.g., 100 (max total uses)',
    'coupon_form_usage_limit_total_help_stub' => 'Leave blank for unlimited total uses.',
    'coupon_form_usage_limit_user_label' => 'Usage Limit Per User (Optional)',
    'coupon_form_usage_limit_user_help_stub' => 'Default is 1. Leave blank or set to 0 for unlimited per user (if total limit exists).',
    'coupon_form_min_spend_label_stub' => 'Minimum Spend to Qualify (Optional)',
    'coupon_form_status_label' => 'Initial Status',
    'button_create_coupon_submit' => 'Create Coupon',
    'success_coupon_created_redirecting_stub' => 'Coupon created! Redirecting... (Stub)',
    'error_coupon_create_failed_unknown_stub' => 'Coupon creation failed. Please check errors. (Stub)',
    'error_coupon_create_failed_network_stub' => 'Network error during coupon creation. (Stub)',
    'page_title_edit_coupon_stub' => 'Edit Coupon (Stub)',
    'error_coupon_id_missing_for_edit_stub' => 'Coupon ID missing for editing. (Stub)',
    'error_coupon_not_found_for_edit_stub' => 'Coupon not found for editing. (Stub)',
    'page_title_edit_coupon_dynamic_stub %s' => 'Editing Coupon: %s (Stub)',
    'button_update_coupon_submit' => 'Update Coupon',
    'success_coupon_updated_redirecting_stub' => 'Coupon updated! Redirecting... (Stub)',
    'error_coupon_update_failed_unknown_stub' => 'Coupon update failed. Check errors. (Stub)',
    'error_coupon_update_failed_network_stub' => 'Network error during coupon update. (Stub)',
    'admin_link_manage_coupons_stub' => 'Manage Coupons',
    'admin_link_manage_coupons_desc_stub' => 'Create, view, and manage discount coupons for your business.',
    'admin_link_manage_coupons_tooltip_stub' => 'Access coupon management tools',

    // Coupon API Error/Success Stubs (from API files, consolidated here for frontend use)
    'error_coupon_business_id_required' => 'Business ID is required for the coupon.',
    'error_coupon_business_not_owned' => 'You can only create coupons for businesses you own.',
    'error_coupon_title_required' => 'Coupon title is required.',
    'error_coupon_discount_type_required' => 'Please select a discount type.',
    'success_coupon_created_stub' => 'Coupon created successfully (Stub)',
    'error_coupon_create_failed_db_stub' => 'Failed to create coupon due to a database issue (Stub).',
    'info_no_coupons_found_stub' => 'No coupons found matching your criteria (Stub).',
    'success_coupons_listed_stub' => 'Coupons listed successfully (Stub).',
    'error_coupon_list_failed_db_stub' => 'Failed to list coupons due to a database issue (Stub).',
    'error_coupon_id_required_for_update' => 'Coupon ID is required for an update.',
    'error_coupon_not_found_for_update_stub' => 'Coupon to update not found (Stub).',
    'error_coupon_update_not_owner_stub' => 'You can only update coupons for businesses you own (Stub).',
    'success_coupon_updated_stub' => 'Coupon updated successfully (Stub)',
    'error_coupon_update_failed_db_stub' => 'Failed to update coupon due to a database issue (Stub).',
    'error_coupon_id_required_for_delete' => 'Coupon ID is required for deletion.',
    'error_coupon_not_found_for_delete_stub' => 'Coupon to delete not found (Stub).',
    'error_coupon_delete_not_owner_stub' => 'You can only delete coupons for businesses you own (Stub).',
    'success_coupon_deleted_stub' => 'Coupon deleted/inactivated successfully (Stub)',
    'error_coupon_delete_failed_db_stub' => 'Failed to delete coupon due to a database issue (Stub).',
